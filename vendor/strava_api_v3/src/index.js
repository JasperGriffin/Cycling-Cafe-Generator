...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActivityStats', 'model/ActivityTotal', 'model/ActivityType', 'model/ActivityZone', 'model/BaseStream', 'model/ClubActivity', 'model/ClubAthlete', 'model/Comment', 'model/Error', 'model/ExplorerResponse', 'model/ExplorerSegment', 'model/Fault', 'model/HeartRateZoneRanges', 'model/Lap', 'model/LatLng', 'model/MetaActivity', 'model/MetaAthlete', 'model/MetaClub', 'model/PhotosSummary', 'model/PhotosSummaryPrimary', 'model/PolylineMap', 'model/PowerZoneRanges', 'model/Route', 'model/Split', 'model/SportType', 'model/StreamSet', 'model/SummaryGear', 'model/SummaryPRSegmentEffort', 'model/SummarySegment', 'model/SummarySegmentEffort', 'model/TimedZoneDistribution', 'model/UpdatableActivity', 'model/Upload', 'model/Waypoint', 'model/ZoneRange', 'model/ZoneRanges', 'model/Zones', 'model/AltitudeStream', 'model/CadenceStream', 'model/DetailedGear', 'model/DetailedSegment', 'model/DetailedSegmentEffort', 'model/DistanceStream', 'model/HeartrateStream', 'model/LatLngStream', 'model/MovingStream', 'model/PowerStream', 'model/SmoothGradeStream', 'model/SmoothVelocityStream', 'model/SummaryActivity', 'model/SummaryAthlete', 'model/SummaryClub', 'model/TemperatureStream', 'model/TimeStream', 'model/TimedZoneRange', 'model/DetailedActivity', 'model/DetailedAthlete', 'model/DetailedClub', 'api/ActivitiesApi', 'api/AthletesApi', 'api/ClubsApi', 'api/GearsApi', 'api/RoutesApi', 'api/SegmentEffortsApi', 'api/SegmentsApi', 'api/StreamsApi', 'api/UploadsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ActivityStats'), require('./model/ActivityTotal'), require('./model/ActivityType'), require('./model/ActivityZone'), require('./model/BaseStream'), require('./model/ClubActivity'), require('./model/ClubAthlete'), require('./model/Comment'), require('./model/Error'), require('./model/ExplorerResponse'), require('./model/ExplorerSegment'), require('./model/Fault'), require('./model/HeartRateZoneRanges'), require('./model/Lap'), require('./model/LatLng'), require('./model/MetaActivity'), require('./model/MetaAthlete'), require('./model/MetaClub'), require('./model/PhotosSummary'), require('./model/PhotosSummaryPrimary'), require('./model/PolylineMap'), require('./model/PowerZoneRanges'), require('./model/Route'), require('./model/Split'), require('./model/SportType'), require('./model/StreamSet'), require('./model/SummaryGear'), require('./model/SummaryPRSegmentEffort'), require('./model/SummarySegment'), require('./model/SummarySegmentEffort'), require('./model/TimedZoneDistribution'), require('./model/UpdatableActivity'), require('./model/Upload'), require('./model/Waypoint'), require('./model/ZoneRange'), require('./model/ZoneRanges'), require('./model/Zones'), require('./model/AltitudeStream'), require('./model/CadenceStream'), require('./model/DetailedGear'), require('./model/DetailedSegment'), require('./model/DetailedSegmentEffort'), require('./model/DistanceStream'), require('./model/HeartrateStream'), require('./model/LatLngStream'), require('./model/MovingStream'), require('./model/PowerStream'), require('./model/SmoothGradeStream'), require('./model/SmoothVelocityStream'), require('./model/SummaryActivity'), require('./model/SummaryAthlete'), require('./model/SummaryClub'), require('./model/TemperatureStream'), require('./model/TimeStream'), require('./model/TimedZoneRange'), require('./model/DetailedActivity'), require('./model/DetailedAthlete'), require('./model/DetailedClub'), require('./api/ActivitiesApi'), require('./api/AthletesApi'), require('./api/ClubsApi'), require('./api/GearsApi'), require('./api/RoutesApi'), require('./api/SegmentEffortsApi'), require('./api/SegmentsApi'), require('./api/StreamsApi'), require('./api/UploadsApi'));
  }
}(function(ApiClient, ActivityStats, ActivityTotal, ActivityType, ActivityZone, BaseStream, ClubActivity, ClubAthlete, Comment, Error, ExplorerResponse, ExplorerSegment, Fault, HeartRateZoneRanges, Lap, LatLng, MetaActivity, MetaAthlete, MetaClub, PhotosSummary, PhotosSummaryPrimary, PolylineMap, PowerZoneRanges, Route, Split, SportType, StreamSet, SummaryGear, SummaryPRSegmentEffort, SummarySegment, SummarySegmentEffort, TimedZoneDistribution, UpdatableActivity, Upload, Waypoint, ZoneRange, ZoneRanges, Zones, AltitudeStream, CadenceStream, DetailedGear, DetailedSegment, DetailedSegmentEffort, DistanceStream, HeartrateStream, LatLngStream, MovingStream, PowerStream, SmoothGradeStream, SmoothVelocityStream, SummaryActivity, SummaryAthlete, SummaryClub, TemperatureStream, TimeStream, TimedZoneRange, DetailedActivity, DetailedAthlete, DetailedClub, ActivitiesApi, AthletesApi, ClubsApi, GearsApi, RoutesApi, SegmentEffortsApi, SegmentsApi, StreamsApi, UploadsApi) {
  'use strict';
